...
const validationSchema = {
    ...
    operationType: Yup.array().min(1,"stockmanagement.userrolescope.validation.locationrequired").of(Yup.string().required()).required("stockmanagement.userrolescope.validation.operationtyperequired"),
